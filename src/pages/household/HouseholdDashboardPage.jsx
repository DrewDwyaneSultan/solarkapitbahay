...
export default function HouseholdDashboardPage({ memberName = 'User' }) {
  ...
  const stats = [
    ...
    { id: 'solar', label: 'Solar Generated', value: `${data.houseA.solar} W`, bgKey: 'solar' },
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-sk-ink-muted mt-1">
            Your share this month: <strong className="text-emerald-800">₱{Math.round(data.savings / 4).toLocaleString()}</strong>
          </p>
        </div>
